...
<template>
  <section class="team user-n w-full relative">
    <div class="team_title">
      <img class="en block md:hidden" src="@/section/appearance/en_title_m.webp" data-aos="fade-up"
        data-aos-duration="1000" data-aos-delay="500" />
      <img class="en hidden md:block" src="@/section/appearance/en_title.webp" data-aos="fade-up"
        data-aos-duration="1000" data-aos-delay="500" />

      <img class="cn block md:hidden" src="@/section/appearance/cn_title_m.png" data-aos="fade-up"
        data-aos-duration="1000" data-aos-delay="500" />
      <img class="cn hidden md:block" src="@/section/appearance/cn_title.webp" data-aos="fade-up"
        data-aos-duration="1000" data-aos-delay="500" />
    </div>
    <div class="wrapper">
      <Splide ref="splideRef" :options="{
        ...
        <SplideSlide>
          <div class="item">
            <div class="pic">
              <img class="block md:hidden" src="@/section/appearance/morning_m.webp" />
              <img class="hidden md:block" src="@/section/appearance/morning.webp" />
            </div>
            <div class="text">
              ...
              <div class="arrow" @click="switch_splide(1)">
                ...
                <img src="@/section/appearance/prev.webp" alt="arrow">
              </div>
            </div>
          </div>
        </SplideSlide>
        <SplideSlide>
          <div class="item">
            <div class="pic">
              <img class="block md:hidden" src="@/section/appearance/night_m.webp" />
              <img class="hidden md:block" src="@/section/appearance/night.webp" />
            </div>
            <div class="text">
              ...
              <div class="arrow" @click="switch_splide(0)">
                <img src="@/section/appearance/next.webp" alt="arrow">
